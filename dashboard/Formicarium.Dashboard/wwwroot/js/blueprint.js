/*
   The interactive section drawing.
   ...
   The script is only fetched when this page is actually visited — 650 kB has no business loading
   behind the live telemetry view.
*/
...
export async function mount(root) {
    ...
    root.innerHTML =
        ...
        '<div class="build-eyebrow">Assemblies</div>' +
        '<ul class="build-key">' +
        ASSEMBLIES.map(a =>
